...
const AllToys = () => {
  ...
  const sortToysByPriceLowToHigh = () => {
    const sortedToys = [...allToys].sort((a, b) => a.price - b.price);
    setAllToys(sortedToys);
  };
  const sortToysByPriceHighToLow = () => {
    const sortedToys = [...allToys].sort((a, b) => b.price - a.price);
    setAllToys(sortedToys);
  };
  return (
    <div className="overflow-x-auto w-full py-16">
      ...
      <div className="flex gap-8 justify-between">
        ...
        <div>
          <button
            onClick={sortToysByPriceLowToHigh}
            className="btn bg-[#ECCC68] border-none text-gray-900"
          >
            $ Low to High
          </button>
          <button
            onClick={sortToysByPriceHighToLow}
            className="btn bg-[#ECCC68] border-none text-gray-900 ml-2"
          >
            $ High to Low
          </button>
        </div>
